(function ($) {
    ...
    var formatters = [
        ...
        { pattern: 'MM',   parser: '\\d{2}',              reader: function () { return leadZeros(this.month + 1, 2); },             mapper: function (value) { this.setUTCMonth(parseInt(value) - 1); } },
        { pattern: 'M',    parser: '\\d{1,2}',            reader: function () { return this.month + 1; },                           mapper: function (value) { this.setUTCMonth(parseInt(value) - 1); } },
